  ...
  return (
    <div className="mt-10 ">
      <div className="text-center">
        ...
        <p>Lorem Ipsum is that it has a more-or-less normal distribution of
letters, as opposed to using Content here, content here', making it look like readable English.</p>
      ...
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
       ...
       <iframe
          ...
          style={{ maxWidth: '100%', border: '0' }} // Ensures no border and max width
          className="absolute inset-0" // Makes the iframe fill the container
          allowFullScreen
        ></iframe>
